...
- [x] 3.2.11 **补漏完成** — mallchat-transaction (4文件) + oss-starter (1文件) Date→LocalDateTime
...
- [~] 4.3.2 Docker Compose `environment:` 敏感值 — 待 App 启动成功后再分离
- [ ] 4.3.3 验证: `docker compose up -d` → 全服务健康 + App 启动
