...
### 4.1 Dockerfile
- [ ] 4.1.1 创建多阶段 `Dockerfile` (Maven构建 + JDK 21 JRE 运行时)
- [ ] 4.1.2 Dockerfile 内置 UTF-8 环境: `ENV LANG=C.UTF-8` + `-Dfile.encoding=UTF-8`
- [ ] 4.1.3 创建 `.dockerignore`
- [ ] 4.1.4 验证: `docker build -t mallchat:latest .`
